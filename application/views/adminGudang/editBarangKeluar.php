    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="<?= base_url('admin_gudang/barang_keluar/edit/' . $id_barang_keluar); ?>" method="post">
            <div class="form-group row">
              <label for="staticEmail" class="col-sm-2 col-form-label">Tanggal Keluar</label>
              <div class="col-sm-10">
                <input type="date" required class="form-control" id="staticEmail" placeholder="Masukan Tanggal Keluar" name="tanggal_keluar" value="<?= $tanggal_keluar; ?>">
              </div>
            </div>
            <div class="form-group row">
