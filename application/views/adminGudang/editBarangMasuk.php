<section class="content">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h3><b><font face=""> Edit Barang Masuk </font></b></h3>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-body">
          ...
          <form action="<?= base_url('admin_gudang/barang_masuk/edit/' . $id_barang_masuk); ?>" method="post">
            <div class="form-group row">
              <label for="staticEmail" class="col-sm-2 col-form-label">Tanggal Masuk</label>
              <div class="col-sm-10">
                <input type="date" required class="form-control" id="staticEmail" placeholder="Masukan Tanggal Masuk" name="tanggal_masuk" value="<?= $tanggal_masuk; ?>">
              </div>
            </div>
            <div class="form-group row">
                ...
                <select name="id_barang" id="id_barang" class="form-control">
                  ...
                  <?php
                    foreach ($barang as $key) {
                      $selected = '';
                      if ($id_barang == $key['id_barang']) {
                        $selected = 'selected';
                      }
                      echo '<option value="' . $key['id_barang'] . '" ' . $selected . '>' . $key['kode_barang'] . '</option>';
                    }
                  ?>
                </select>
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="date" required class="form-control" id="staticEmail" placeholder="Masukan Tanggal Kadaluwarsa" name="tanggal_kadaluwarsa" value="<?= $tanggal_kadaluwarsa; ?>">
              </div>
            </div>
            <div class="form-group row">
